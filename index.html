      ...
      <div class="navigation">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-2">
              <a href="#" class="logo">
                Nova<span class="logo__blue">VPN</span
          ...
          <div class="col d-flex justify-content-center">
            <div class="advantages-title text-center">
              <h2 class="advantages-title__title text-cente" id="features">
                Here’s what you get with the full-featured Nova<span
          ...
          <div class="row">
            ...
            <div class="col-lg-4">
              <div class="advantage">
                ...
                <p class="advantage__text">
                  ...
                  NovaVPN secures your data with military-grade encryption.
                </p>
              </div>
            </div>
            <div class="col-lg-4">
            ...
            <div class="col-lg-4">
              <div class="advantage">
                ...
                <p class="advantage__text">
                  With a single account, you can set up NovaVPN on 6 gadgets at
          ...
          <div class="col d-flex justify-content-center">
            <div class="reviews-title text-center">
              ...
              <p class="reviews-title__text">
                People say the nicest things about NovaVPN.
              </p>
            </div>
          </div>
        </div>
            ...
            <div class="slider swiper-container d-flex justify-content-center">
              <div class="swiper-wrapper d-flex justify-content-center">
                ...
                <article class="slide swiper-slide">
                  ...
                  <div class="massage">
                   <p class="massage__mas">
                    NovaVPN is fantastic! Excellent apps
